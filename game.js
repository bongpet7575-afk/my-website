...
const MONSTER_TEMPLATES = {
  ...
  cave_spider:     {id:'cave_spider',    name:'🕷️ Cave Spider',     icon:'spider',  hp:30000, atk:1800, armor:200, hit:200, dodge:200, xp:240, gold:[120,200]},
  venom_spider:    {id:'venom_spider',   name:'🕷️ Venom Spider',    icon:'spider',  hp:40000, atk:2200, armor:250, hit:250, dodge:250, xp:300, gold:[160,260]},
  giant_spider:    {id:'giant_spider',   name:'🕷️ Giant Spider',    icon:'spider',  hp:52000, atk:2700, armor:320, hit:300, dodge:300, xp:370, gold:[200,320]},
  queen_spider:    {id:'queen_spider',   name:'🕷️ Queen Spider',    icon:'spider',  hp:68000, atk:3200, armor:400, hit:360, dodge:360, xp:450, gold:[250,400]},
  goblin_scout:    {id:'goblin_scout',   name:'👹 Goblin Scout',    icon:'goblin',  hp:80000, atk:3800, armor:500, hit:440, dodge:440, xp:540, gold:[300,480]},
  goblin_warrior:  {id:'goblin_warrior', name:'👹 Goblin Warrior',  icon:'goblin',  hp:100000,atk:4500, armor:600, hit:520, dodge:520, xp:650, gold:[380,580]},
  goblin_shaman:   {id:'goblin_shaman',  name:'👹 Goblin Shaman',   icon:'goblin',  hp:130000,atk:5200, armor:720, hit:620, dodge:620, xp:780, gold:[460,700]},
  goblin_elite:    {id:'goblin_elite',   name:'👹 Goblin Elite',    icon:'goblin',  hp:165000,atk:6000, armor:860, hit:740, dodge:740, xp:940, gold:[560,840]},
  skeleton_archer: {id:'skeleton_archer',name:'💀 Skeleton Archer', icon:'skeleton',hp:200000,atk:7000, armor:1000,hit:880, dodge:880, xp:1100,gold:[660,1000]},
  skeleton_warrior:{id:'skeleton_warrior',name:'💀 Skeleton Warrior',icon:'skeleton',hp:250000,atk:8200,armor:1200,hit:1040,dodge:1040,xp:1320,gold:[800,1200]},
  skeleton_mage:   {id:'skeleton_mage',  name:'💀 Skeleton Mage',   icon:'skeleton',hp:310000,atk:9600, armor:1440,hit:1220,dodge:1220,xp:1580,gold:[960,1440]},
  skeleton_knight: {id:'skeleton_knight',name:'💀 Skeleton Knight', icon:'skeleton',hp:390000,atk:11200,armor:1700,hit:1440,dodge:1440,xp:1900,gold:[1160,1740]},
  orc_grunt:       {id:'orc_grunt',      name:'👊 Orc Grunt',       icon:'orc',     hp:480000,atk:13000,armor:2000,hit:1700,dodge:1700,xp:2280,gold:[1400,2100]},
  orc_warrior:     {id:'orc_warrior',    name:'👊 Orc Warrior',     icon:'orc',     hp:600000,atk:15200,armor:2360,hit:2000,dodge:2000,xp:2740,gold:[1680,2520]},
  orc_shaman:      {id:'orc_shaman',     name:'👊 Orc Shaman',      icon:'orc',     hp:740000,atk:17800,armor:2780,hit:2340,dodge:2340,xp:3280,gold:[2020,3020]},
  orc_berserker:   {id:'orc_berserker',  name:'👊 Orc Berserker',   icon:'orc',     hp:920000,atk:20800,armor:3260,hit:2740,dodge:2740,xp:3940,gold:[2420,3640]},
  vampire_thrall:  {id:'vampire_thrall', name:'🧛 Vampire Thrall',  icon:'vampire', hp:1140000,atk:24400,armor:3820,hit:3220,dodge:3220,xp:4720,gold:[2900,4360]},
  vampire_hunter:  {id:'vampire_hunter', name:'🧛 Vampire Hunter',  icon:'vampire', hp:1400000,atk:28600,armor:4480,hit:3780,dodge:3780,xp:5680,gold:[3500,5240]},
  vampire_noble:   {id:'vampire_noble',  name:'🧛 Vampire Noble',   icon:'vampire', hp:1720000,atk:33400,armor:5240,hit:4420,dodge:4420,xp:6820,gold:[4200,6300]},
  vampire_elder:   {id:'vampire_elder',  name:'🧛 Vampire Elder',   icon:'vampire', hp:2120000,atk:39000,armor:6140,hit:5180,dodge:5180,xp:8180,gold:[5040,7560]},
  cave_troll:      {id:'cave_troll',     name:'👾 Cave Troll',      icon:'troll',   hp:2600000,atk:45600,armor:7180,hit:6060,dodge:6060,xp:9820,gold:[6050,9080]},
  rock_troll:      {id:'rock_troll',     name:'👾 Rock Troll',      icon:'troll',   hp:3200000,atk:53200,armor:8400,hit:7080,dodge:7080,xp:11780,gold:[7260,10900]},
  frost_troll:     {id:'frost_troll',    name:'👾 Frost Troll',     icon:'troll',   hp:3940000,atk:62200,armor:9820,hit:8280,dodge:8280,xp:14140,gold:[8720,13080]},
  war_troll:       {id:'war_troll',      name:'👾 War Troll',       icon:'troll',   hp:4860000,atk:72800,armor:11480,hit:9680,dodge:9680,xp:16960,gold:[10460,15700]},
  demon_scout:     {id:'demon_scout',    name:'😈 Demon Scout',     icon:'demon',   hp:5980000,atk:85000,armor:13420,hit:11320,dodge:11320,xp:20360,gold:[12560,18840]},
  demon_warrior:   {id:'demon_warrior',  name:'😈 Demon Warrior',   icon:'demon',   hp:7360000,atk:99400,armor:15680,hit:13220,dodge:13220,xp:24440,gold:[15080,22620]},
  demon_mage:      {id:'demon_mage',     name:'😈 Demon Mage',      icon:'demon',   hp:9060000,atk:116200,armor:18320,hit:15460,dodge:15460,xp:29320,gold:[18100,27140]},
  demon_knight:    {id:'demon_knight',   name:'😈 Demon Knight',    icon:'demon',   hp:11160000,atk:135800,armor:21400,hit:18060,dodge:18060,xp:35180,gold:[21720,32580]},
  shadow_wraith:   {id:'shadow_wraith',  name:'🌑 Shadow Wraith',   icon:'werewolf',hp:13740000,atk:158800,armor:25000,hit:21120,dodge:21120,xp:42220,gold:[26060,39100]},
  shadow_knight:   {id:'shadow_knight',  name:'🌑 Shadow Knight',   icon:'werewolf',hp:16920000,atk:185600,armor:29220,hit:24680,dodge:24680,xp:50660,gold:[31280,46920]},
  shadow_mage:     {id:'shadow_mage',    name:'🌑 Shadow Mage',     icon:'werewolf',hp:20840000,atk:217000,armor:34160,hit:28860,dodge:28860,xp:60800,gold:[37540,56300]},
  shadow_lord:     {id:'shadow_lord',    name:'🌑 Shadow Lord',     icon:'werewolf',hp:25680000,atk:253800,armor:39940,hit:33720,dodge:33720,xp:72960,gold:[45050,67580]},
  eternal_guard:   {id:'eternal_guard',  name:'🌟 Eternal Guard',   icon:'phoenix', hp:31640000,atk:296800,armor:46680,hit:39420,dodge:39420,xp:87560,gold:[54060,81100]},
  eternal_warrior: {id:'eternal_warrior',name:'🌟 Eternal Warrior', icon:'phoenix', hp:38980000,atk:347000,armor:54600,hit:46080,dodge:46080,xp:105080,gold:[64880,97320]},
  eternal_mage:    {id:'eternal_mage',   name:'🌟 Eternal Mage',    icon:'phoenix', hp:48020000,atk:405800,armor:63860,hit:53880,dodge:53880,xp:126100,gold:[77860,116800]},
  eternal_champion:{id:'eternal_champion',name:'🌟 Eternal Champion',icon:'phoenix',hp:59160000,atk:474600,armor:74680,hit:63000,dodge:63000,xp:151300,gold:[93440,140160]},
};
